...
from processors.transformations.chicago_pipeline import handleMissingAndDuplicates_pipeline, featureEngineering_pipeline
from typing import List
from processors.transformations.transformation import Transformation

class ChicagoProcessor(DataSetProcessor):
    def __init__(self):
        logger: Logger = Logger.from_dotenv('chicago_processor.csv', LogType.TRANSFORMATION)
